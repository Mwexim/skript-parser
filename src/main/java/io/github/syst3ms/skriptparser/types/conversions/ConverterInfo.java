...
public final class ConverterInfo<F, T> {
    ...
    public ConverterInfo(Class<F> from, Class<T> to, Function<? super F, ? extends T> converter, @MagicConstant(intValues = {Converters.ALL_CHAINING, Converters.NO_LEFT_CHAINING, Converters.NO_RIGHT_CHAINING, Converters.NO_CHAINING}) int flags) {
        this.from = from;
        this.to = to;
